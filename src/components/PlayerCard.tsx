    ...
    >
      ...
      <div className="flex items-center gap-4 px-4 pb-3 pt-4">
        ...
        <div className="min-w-0 flex-1">
          <p className="hero-number truncate text-[28px] uppercase leading-none tracking-tight text-chalk-50">
            {player.name}
          </p>
        ...
        <div className="shrink-0 text-right">
          <p className="hero-number text-[52px] leading-[0.86] text-volt lg:text-[64px]">
      ...
      {nextBadge && (
        <div className="flex items-baseline justify-between gap-3 border-t border-pitch-700 bg-pitch-900/60 px-4 py-2.5">
          ...
          <span className="truncate font-label text-xs font-semibold text-chalk-300">
            {nextBadge.hint}
          </span>
        </div>
      )}
